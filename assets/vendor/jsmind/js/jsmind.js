...
; (function ($w) {
    ...
    jm.view_provider.prototype = {
        ...
        create_node_element: function (node, parent_node) {
            ...
            var d = $c('jmnode');
            if ("attr" in node.data) {
                for (const [key, value] of Object.entries(node.data.attr)) {
            ...
            if (node.isroot) {
                ...
                $t(d_e, '-');
                d_e.className = 'jmexpander-minus';
        ...
        show_nodes: function () {
            ...
            for (var nodeid in nodes) {
                ...
                if (!node.isroot && node.children.length > 0) {
                    ...
                    if (node.expanded) {
                        expander.className = 'jmexpander-minus';
                    } else {
                        expander.className = 'jmexpander-plus';
                    }
